        ...
        if (this.config.email && this.config.password) {
            ...
            for (var i = 0; i < this.apcDevices.length; i++) {
                ...
                if (existingAccessory) {
                    ...
                    let apcAccessory = new APCHomeAccessory_1.default(this, existingAccessory, this.config, this.log, this.apcDevices[i], this.apcService);
                    ...
                    let apcAccessory = new APCHomeAccessory_1.default(this, accessory, this.config, this.log, this.apcDevices[i], this.apcService);
